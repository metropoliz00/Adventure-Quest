                  ...
                  <div className="space-y-1">
                    ...
                    {email ? (
                      ...
                      <button
                        ...
                        className="w-full bg-amber-600 text-white rounded-lg px-3 py-1.5 text-xs font-bold transition-all hover:bg-amber-700 flex items-center justify-center gap-2"
                      >
                        Sign in with Google
                      </button>
                    )}
